...
\TODO{let's not put citations at the beginning of a sentence. Being graphical
is a feature, but it is not a "Background". rephrase it as a comparison to
other tools.}
...
\end{itemize}
\TODO{number these two polices. bullets for less than 3 items is discouraged}
...
\TODO{as a general comment: you should use some figures to illustrate
the architecture, or just a sample GUI interface}
