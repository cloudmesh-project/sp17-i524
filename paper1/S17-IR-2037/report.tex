...
The advent of computer systems in the later part of 20th century facilitated the increase in the digitization of documents that were in existence. In order to share those documents and files among peers situated remotely, there raised a need for a mechanism which could facilitate file sharing. File Transfer Protocol developed in the late 1970s provided an efficient and reliable mechanism for sharing files among hosts.\newline
\end{abstract}
...
\end{tabular}
\caption{Comparison of Functionalities - FTP Clients}
\end{table*}
