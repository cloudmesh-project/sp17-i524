...
\TODO{Abstract: Don't use in this paper term.}


\tableofcontents % Print the contents section
\section{Introduction}
\TODO{
\GE usage of 'a' appropriately must be there. 
}
...
\TODO{
  Use proper referencing of images by using label and ref tags in latex.
}
...
\TODO{
  \GE Not FTP Clients, FTP clients. (use capitalization properly).  
}
\section{FTP Clients}
...
\TODO{
  Use latex label and reference tags for referencing components in the paper.
  \GE Check grammar when plural words are used. 
}
...
\TODO{
  Use comma for combining long or complex sentences.
  Use proper format to reference components in the paper. 
}
...
\section{Conclusion}
\TODO{
  Don't use this paper term. Use 'In reference to the facts, or just start the conlusion with a proper starter sentence'.
  Check grammar in long sentence when combining long sentences. 
}
