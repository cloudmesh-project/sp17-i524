...
\begin{abstract}
Apache Samza is a stream processing framework which enables usesrs\SE to analyze
streaming datawith\SE ease. The concepts required streaming data and the 
...
\TODO{Abstract: please fix spelling errors}
...
\TODO{A list is provided but should condense the list as a paragraph or provide a description for each item. Also, you should define and cite YARN }
...
\TODO{A list is provided but should condense the list as a paragraph or provide a description for each item. }
...
\TODO{The use of nomenclature, such as  NM and RM may not be clear to the reader and should be defined appropriately.}
...
\TODO{As a general rule, try to avoid the use of you when trying to writing a technical report}
...
\TODO{It may be best to define the API in a latex algorithm or code block}
