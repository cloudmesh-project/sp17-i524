...
\TODO{Overall, a good paper, that focuses a little too much in some fine details, without providing a proper context for why Spark is useful, where it fits with other Big Data technologies, why it's relevant, and so on. Please expand the introduction a bit and include a conclusion that sets a little more context.}
