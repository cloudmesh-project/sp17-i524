...
\end{figure}
\section{Licensing}
Apache Sqoop is available as an open source software, provided to download via multiple mirrors in the Sqoop website\cite{down}. The source code is also shared via GitHub \cite{git} for developers to fork and modify it. \TODO{honestly, I don't think these links are references. they are footnotes}
