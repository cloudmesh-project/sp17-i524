...
disscussed in section 3.\TODO{section 3 is licensing in your paper} Azure machine learning also offers
...
\TODO{subsection 2.2 and 2.3 cannot fit in the topic of "Azure components", can they?}
...
\TODO{it is good to have a use case section. however, try to avoid
magazine style use cases, instead, give a simple but concret use case
to demo how to build a sample Azure project will make your paper outstanding}
