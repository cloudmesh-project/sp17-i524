...
\TODO{the above three sections are too general. should be reduced to
one Background section}
...
\TODO{HTTP requests are used in web APIs. but what are those API message
definitions? It needs to be shown to help people understand how to use
this API.}
