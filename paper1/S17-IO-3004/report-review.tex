...
\TODO{[citation] and then period}
\TODO{can be more technical. they are technical features can be outlined, other than story-like history.}
...
\TODO{The problem of the above three sections -- you should assume your audiences are familiar with a typical DBMS. They use Postgres, Oracle, etc. and want to know unique features about MySQL. I see the difficulty that MySQL is in many ways a typical relational database and hard to distinguish. But you still have to let me see you tried so and your efforts. For example, they gonna be some reasones why MySQL is this popular. The pros and cons compare with another counterparts.}
...
\TODO{use cases are only good when they help you understand the technology specs of the subject. After all, we don't sell MySQL. Here are some examples I picked from you use case: CERN deals with large amount of storage, why MySQL is capable? boo-box access MySQL via Ruby and Python, what are these programing language APIs like? Since scalability is an benefit using MySQL, how it scales up and down?}
...
\TODO{it is good to have these comparison. develop this section more.}
