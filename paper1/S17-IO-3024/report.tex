...
light weight guest OS. \cite{www-semantics}
...
from the table below 
  ...
  Index. Please see the blow diagram from the comparison \cite{www-semantics}
\begin{figure}[htbp]
\centering
...
\item Memory Performance \\
 Below are test results  using STREAM \cite{www-semantics}
\begin{figure}[htbp]
\centering
...
Network  I/O is measured with Netperf \cite{www-semantics} \\
\begin{figure}[htbp]
\centering
