...
\begin{abstract}
Management of departments, employees, management tools and other entities for an organization is a vital task. In achieving this goal, there are many supporting tools that has been designed to monitor performance, security issues, network traffic, internet speed and many other vital features which are considered as major components in management of an organization. Nagios can be considered as a tool which support this context with a wide varitey of features such as network monitoring, performance analysis, reporting and a management tool to achieve organizational goals. In this paper, it is being  explored what Nagios is capable achieving these tasks and the key factors that made it standing-out among other monitoring tools.
\end{abstract}
