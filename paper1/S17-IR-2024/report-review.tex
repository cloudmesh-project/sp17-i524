...
TCP/IP is more and it consumes less resources.\TODO{when you compare these two
stacks, "consume less resources" is a very strong claim, any citations?} The functional model of
