...
steps:- \newline1)Each worker has a local query engine that executes a
...
lie in the database community. \newline2)Tajo can make use of various
...
part of another relation resides.\newline3) In Tajo, a physical plan that a
