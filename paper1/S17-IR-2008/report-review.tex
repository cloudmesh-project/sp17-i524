...
\TODO{better cite the FB case, as it is not a common knowledge. But rather just remove this sentence. It is an interesting fact, but not general enough for an introduction, unless you want to enumerate examples.}

HadoopDB\cite{hadoopdb} is and open source component that serves as exactly such a hybrid system. It is a hybrid of a parallel database and MapReduce technologies. It approaches parallel databases in performance and efficiency, and also yields the scalability, fault tolerance, and flexibility of MapReduce systems. It uses PostgreSQL as the database layer and Hadoop as the communication layer, Hive as the translation layer. It has been demonstrated on clusters with 100 nodes and should scale as long as Hadoop scales. \TODO{concrete numbers always look better with citations}
