...
\begin{abstract}
Azure Data Factory is a cloud based data integration service that handles and automates data movement and data integration services. The Data Factory stands out in it's ability to ingest data from multiple sources, efficiently build pipelines to manage processes and visualize the results in a pragmatic manner. This paper discusses the data movement and data transformation activities supported by Azure Data Factory \newline
\end{abstract}
