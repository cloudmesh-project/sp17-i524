...
\TODO{It's unnecessary to cite repeatedly.}
...
\TODO{
GitHub here needs citation. The repeated one can be removed.
...
\TODO{Repeated citation.} Since February 2013, the Apache Crunch project continues to be used, maintained and improved in an open source fashion, as explained in Section \ref{source}.
