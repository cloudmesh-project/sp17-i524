...
Due to its following critical features, Apache REEF drastically simplifies development of resource managers \cite{reefhome}.
...
Given REEF's position in the big data stack, there are three relationships to consider: Projects that fit below, on top of, or alongside REEF in the stack \cite{reefproposal}.
