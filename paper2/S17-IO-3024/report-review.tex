...
\TODO{I would revise the first sentence to Puppet is a programming language, etc. }
...
\TODO{It would be helpful to the reader if you could provide a description of the screenshots for the subsections}
\section{Advantages} 
