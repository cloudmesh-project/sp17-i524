...
\TODO{Abstract is the summary of your paper. Furthermore, this is
actually a technology review. No need for background story in abstract.}
...
analysis.
\TODO{Background story within a tech review is not needed. You should
start with Google BigQuery is ...}
...
\TODO{Bullet points within a paper is not encouraged.}
\noindent

\TODO{This session is too much just to explain Google BigQuery applies SaaS.
There is no clear connection between the previous paragraph and the following
one.}
...
\TODO{I am totally confused here. So figure 1 is the system architecture of
Google BigQuery. But you only mentioned the architecture figure by mentioning
several export tools shown in it. What's the logic in that? Shouldn't you
introduce the architecture figure then describe it in detail as you did in next
paragraph?}
...
\TODO{No need to cite repeatedly.}
...
\TODO{You are clearly talking about some other figure since figure 2 here is
Row-oriented vs Column-oriented Storage, which clearly belongs to previous
section. If you want to emphasize on the binary tree architecture within the
figure, you should mention it clearly.}. This helps retrieve data much
...
fewer servers.
\TODO{I am not quite sure the examples of tree architecture here helps. I feel
very confused after reading the example because you didn't depict them clearly.
For example, how did you get the speedup of 0.33x?
}
...
\TODO{You clearly directly copied the same error within your reference}.
 The
...
\end{itemize}
\TODO{This part is clearly SQL code. But now it just looks a mess. Better way
is put figure here instead of text.}
\begin{figure}[htbp]
\centering
...
\TODO{Use case on Big Data is needed.}
