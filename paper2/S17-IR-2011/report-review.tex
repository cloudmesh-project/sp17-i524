...
\TODO{Paper2, not project-000}
\TODO{Reference www-hyperv-paper here is clearly not web page, so it shouldn't
be misc. It more looks like a booklet.}
...
\TODO{VMware vSphere needs citation too. }
...
\TODO{Each os needs citation here.}
...
\TODO{Full name please for the first occurrence.} mode
...
\SE
Windows Serven \SE 2012 R2, VMware vSphere Hypervisor and VMware vSphere
...
\TODO{I don't see any use cases.}
% Bibliography
