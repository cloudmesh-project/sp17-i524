...
\doi{\url{https://github.com/Anveling/sp17-i524/blob/master/paper2/S17-IR-2016/report.pdf}}
...
marker. Currently used file metadata properties are, avro.schema which
contains the schema of the objects stored in file avro.codec contains
the name of the compression codec used to compress the blocks.
...
objects and a 16-byte sync marker.
