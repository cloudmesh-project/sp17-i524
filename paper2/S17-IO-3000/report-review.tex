...
services. Apache Ranger is part of the Hadoop eco-system\SE. Apache Ranger
...
\TODO{Introduction: When writing you should be careful to be gender specific pronouns, such as HE.  Also, please provide a comma after which. Remove the backslash character users/user-groups }
...
\TODO{Architecture Overview:Ranger Admin Portal: add an a before user. Use lowercase policy database and admin portal}
