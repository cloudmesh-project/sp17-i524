...
\doi{\url{https://github.com/sakorrap/sp17-i524/blob/master/paper2/S17-IR-2013/report.pdf}}

\begin{abstract}
This paper provides a brief introduction to OpenCV. OpenCV is an open source computer vision and machine learning software library, which was originally introduced more than a decade ago by Intel. The library has more than 2500 optimized algorithms, which includes a comprehensive set of computer vision and machine learning algorithms \cite{www-opencv}. 
\newline
\end{abstract}
