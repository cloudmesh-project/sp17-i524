...
\TODO{Please include the correct URL for your paper under the
  \emph{cloudmesh} Github user, not \emph{yatinsharma7}.}

\TODO{Abstract: Needs to be reworked. A "cloud application program" is
  very unspecific. No piece of software provides "everything a
  developer would need". You need to succinctly state what is most
  important about Heroku, so the reader can know in what contexts it's
  used and what problems it solves. The current abstract is too
  generic and doesn't achieve that.}

\TODO{General language and formatting: Please avoid using "our" and
  "we" as much as you have in the paper. In addition, always include a
  space after punctuation like periods, commas, etc.}

\TODO{Your paper does not meet the length requirements for the
  assignment. You need to expand it. This shouldn't be difficult,
  since in several places you don't provide enough context or
  detail. In addition, you need to make sure you use citations
  properly, and you make the language of the paper more specific and
  less conversational. Finally, the organization and flow of the paper
  can be improved by providing proper transitions between sections and
  subsections. See below for more detailed comments.}

\TODO{Assessment: Major revisions required. Please address the review
  comments below.}

\section{Introduction}
	Heroku\cite{Heroku} is Platform as a Service(Paas)\cite{PaaS} that enables us to
	build application in any language on demand. \TODO{Misleading. Heroku only supports a specific list of languages, not "any language on demand". You need to deploy a buildpack for anything else.} It allows us to deploy web
	applications seamlessly as well as monitor and share with other developers at
	the click of a button. \TODO{"at the click of a button" is subjective and doesn't belong in a paper like this} It is all about \TODO{"It is all about..." is too conversational and unspecific. Please revise.} rapid application development for the
	cloud, using the underlying platform infrastructure and software add-ons to
	build, deploy and monitor large and scalable web \TE application. At present it
	handles 5 billion requests per day. \TODO{This is a specific quantitative claim. You need to provide a reference.}
...
\section{Benefits}
	...
	support for Ruby, Java, Python, Node.js, and PHP. \TODO{This is not the full list of languages Heroku supports.} Also, any other language can
	...
	Heroku is  Git\cite{Git} focused \TODO{What does that mean, Git focused?} and makes it easy to share code using version
	controlling. \TODO{How is Heroku easier to share code using version controlling compared to any platform?} Heroku is also a part of the Salesforce family. \TODO{What is the "Salesforce family", please provide more detail.} It has a feature
...
\section{Architecture}
	\begin{figure}[htbp]
		...
		\caption{High Level Architecture of Heroku platform \TODO{Did you create this figure? If not, you need to provide a reference to where you got it from.}}
		\label{fig:Herokul-arch}
	\end{figure}

        \TODO{Figure~\ref{fig:Herokul-arch} is never reference in the text of the paper.}
	...
	restarts them automatically, hence removing a lot of maintenance hassles.
        ...
        \TODO{The subsections below are place without much context or
          explanation as to how they relate to each other or the
          overal architecture. Please improve the flow of the paper by
          providing transitions between the different sections and
          subsections.}
...
\section{Getting started}
	...
	Heroku Client, Foreman and Git. \TODO{You need to provide resources for getting started with Heroku.}

\section{Conclusion}
	Heroku is dramatically \TODO{"dramatically" is subjective and shouldn't be used in a paper where you're aiming for a neutral tone.} different from the traditional hosting or any normal \TE \TODO{What is a "normal" cloud infrastructure offering?}
	...
	experience and application runtime and also frees the developer from hassles \TODO{"frees the developer from hassles" is subjective} of
