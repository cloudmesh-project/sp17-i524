...
U.S.A.}
%\affil[2]{School of Science, University of Technology, 2000 J St. 
...
\begin{abstract}
 ...
 Apache HAWQ  for data science and machine learning workloads. It can 
 be used to gain deeper and actionable insights into data with out 
 the need from moving data to another platform to perfrom advanced 
 analytics. \newline
\end{abstract}
