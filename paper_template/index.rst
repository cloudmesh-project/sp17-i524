...
Please note that we may update this format and it will be in your
responsibility to check if your report follows the format.

Once you copy the content of this directory you can go to it and use
the conveneint Makefile to create the report. THis assumes you have
LaTeX installed.
