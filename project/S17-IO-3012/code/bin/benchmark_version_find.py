...
def make_figure(find_seconds_32, shards_32, find_seconds_34, shards_34):
    ...
    # Make the chart
    plt.plot(shards_32, find_seconds_32, label='Version 3.2')
    plt.plot(shards_34, find_seconds_34, label='Version 3.4')
    ...
    # plt.show()
    # Save the chart
    fig.savefig('../report/version_find.png')
...
if __name__ == "__main__":
    ...
    #percentage death=\
    find_seconds_32=select_df.as_matrix(columns=[select_df.columns[7]])
    ...
    #http://stackoverflow.com/questions/31791476/pandas-dataframe-to-numpy-array-valueerror
    #percentage death=\
    find_seconds_34=select_df.as_matrix(columns=[select_df.columns[7]])
    shards_34 = select_df.as_matrix(columns=[select_df.columns[3]])
    #http://stackoverflow.com/questions/31791476/pandas-dataframe-to-numpy-array-valueerror

    make_figure(find_seconds_32, shards_32, find_seconds_34, shards_34)
