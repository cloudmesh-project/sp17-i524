...
\dates{Project: S17-IR-2013,\today}

\ociscodes{Hadoop, Ad click Prediction, BigData, Ansible, Chameleon cloud, Apache Pig, HDFS, MapReduce, I524}


\doi{Report: \url{https://github.com/cloudmesh/sp17-i524/tree/master/project/S17-IR-2013/report/report.pdf}\\
Code: \url{https://github.com/cloudmesh/sp17-i524/tree/master/project/S17-IR-2013/code}
