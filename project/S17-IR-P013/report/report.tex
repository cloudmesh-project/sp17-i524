...
\begin{itemize}
\item [weatherClusterMaster]\item <ipaddress1> ansible_ssh_user=cc\item [weatherClusterSlave]\item <ipaddress2>  ansible_ssh_user=cc\item <ipaddress3ansible_ssh_user=cc
\end{itemize}
...
\begin{itemize}
\item ---\item - hosts: weatherClusterMaster\item remote_user: root roles:\item     - java\item     - hadoop\item     - hbase\item     - master\item - hosts: weatherClusterSlave remote_user: root\item roles:\item     - java\item     - hadoop\item     - hbase
\end{itemize}
