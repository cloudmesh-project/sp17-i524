...
if("TRUE" STREQUAL "TRUE")
  set(mybot_control_SOURCE_PREFIX /home/eunosm3/rosProject/rosProjFinal/mybot_ws/src/mybot_control)
  set(mybot_control_DEVEL_PREFIX /home/eunosm3/rosProject/rosProjFinal/mybot_ws/devel/.private/mybot_control)
  ...
  set(mybot_control_INSTALL_PREFIX /home/eunosm3/rosProject/rosProjFinal/mybot_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'mybot_control' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'eunosm3 <eunosm3@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'mybot_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eunosm3/rosProject/rosProjFinal/mybot_ws/src/mybot_control/${idir}'.  Ask the maintainer 'eunosm3 <eunosm3@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/eunosm3/rosProject/rosProjFinal/mybot_ws/devel/.private/mybot_control/lib;/home/eunosm3/rosProject/rosProjFinal/mybot_ws/devel/lib;/media/storage/github/cloudmesh/cloudmesh.ros/rosProj2/rosbot08/devel/lib;/home/eunosm3/rosProject/rosProj2/rosbot03/devel/lib;/opt/ros/kinetic/lib)
