...
we deploy storm on various clouds and benchmark the performance, doing real time 
processing on sample datasets. First, we describe the architecture of Storm, its 
deployment and its methods for distributed scaleout and fault-tolerance. We 
performed a deployment and performance benchmarking to realise the storm on
various clouds. We identified and examined the best clouds for
