...
\doi{\url{https://github.com/cloudmesh/sp17-i524/blob/master/project/S17-IR-P010/report.pdf}}
...
\begin{figure}[htbp]
  \centering
  \fbox{\includegraphics[width=\linewidth]{images/BeforeOpenCV}}
  \caption{Usage statics before OpenCV installation}
\end{figure}

\begin{figure}[htbp]
  \centering
  \fbox{\includegraphics[width=\linewidth]{images/AfterOpenCV}}
...
\begin{figure}[htbp]
  \centering
  \fbox{\includegraphics[width=\linewidth]{images/LatencyTest}}
