...
to perform detection is by using Haar Cascades.  This technique
has been applied to vehicle detection by creating a haar-cascade
cars.xml file which has been trained using 526 rear-end images of
cars.  The dataset currently used is the Car dataset proposed by Brad
Philip and Paul Updike.  Haar classifiers, based on
Haar Cascades, are a machine learning based approach wherein multiple
positive and negative images are used to train the classifier for
classification.\newline
\end{abstract}
