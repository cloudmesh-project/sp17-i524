...
code:\url{https://github.com/cloudmesh/sp17-i524/tree/master/project/S17-IR-P001/code/ansible}
}
...
\textbf{Textblob-1000 tweets}                                                     & 1              & 0.21s            \\
...
\begin{table}[htb]
\centering
\caption{Running time of Naive Bayes model on 1-3 nodes}
\label{runtime}
\begin{tabular}{|l|l|}
\hline
\multicolumn{2}{|c|}{\textbf{Run time of Naïve Bayes}} \\ \hline
\textbf{No. of nodes}   & \textbf{Run Time (in s)}  \\ \hline
1                           & 32                        \\ \hline
2                          & 24                        \\ \hline
3                          & 30                        \\ \hline
\end{tabular}
